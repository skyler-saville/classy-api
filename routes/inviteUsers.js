...
router.route('/confirm/:token') // user will be emailed the link (which expires in 1 day)
  .post( async (req, res) => {
    console.log('Trying to confirm the invited user')
    if (req.params.token) {
      console.log(`investigating ${req.params.token}`)
